...
class _WorkerLoginScreenState extends State<WorkerLoginScreen> {
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              const Text(
                'Karigar Login & Trade Union Escrow Hub',
                style: TextStyle(
                  fontSize: 12,
  ...
  Widget _buildHeadingSection() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            _isOtpSent ? 'Verify registered mobile' : 'Partner Sign-in',
            style: const TextStyle(
              fontSize: 22,
              fontWeight: FontWeight.w800,
              color: AppColors.primary,
  ...
  Widget _buildUnionProtectionCallout() {
    return Container(
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  '100% Direct Karigar Payout Guarantee',
                  style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.w700,
                    color: AppColors.onTertiaryContainer,
      ...
      child: ElevatedButton(
        ...
        child: _isLoading
            ...
            : Row(
                ...
                children: [
                  Text(
                    _isOtpSent ? 'Verify & Open Partner Hub' : 'Send Partner OTP',
